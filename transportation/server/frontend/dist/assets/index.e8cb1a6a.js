...
`,P=({children:e,className:n})=>u(pe,{className:n,children:[t("svg",{className:"spin",children:t("use",{xlinkHref:"#icon-loading"})}),t("p",{children:e})]}),he=e=>new Promise((n,r)=>{const s=new Image;s.onload=()=>{n(s)},s.onerror=o=>{r(o)},s.src=e}),ge=a(P)`
  width: 256px;
  height: 256px;
`,me=({content:e})=>{const[n,r]=d.exports.useState(null);e=encodeURIComponent(e);const[s,o]=d.exports.useState(!1),[i,l]=d.exports.useState(null);return d.exports.useEffect(()=>{if(!e)return;const c=`/api/v1/qrcodes?content=${e}`;o(!0),he(c).then(()=>r(t("img",{width:"256",height:"256",src:c})),p=>l(p)).finally(()=>o(!1))},[e]),s?t(ge,{children:"\u52A0\u8F7D\u4E2D"}):i?u("div",{children:["\u52A0\u8F7D\u4E8C\u7EF4\u7801\u51FA\u9519\uFF1A",JSON.stringify(i)]}):n},w=K.create({timeout:5e3}),xe=`ws://${window.location.hostname}:27149/ws`,j=new WebSocket(xe);class fe{constructor(n){this.client=n}send(n){this.client.send(JSON.stringify(n))}onMessage(n){this.client.onmessage=({data:r})=>{n(JSON.parse(r))}}}const Fe=new Promise((e,n)=>{j.onopen=()=>{e(new fe(j))},setTimeout(()=>{n(new Error("get ws connection timeout"))},1e4)}),T=()=>Fe;let x=localStorage.getItem("clientId");(x==null?void 0:x.length)!==36&&(x=Z(),localStorage.setItem("clientId",x));const C=a.div`
...
`,J=({content:e,onClose:n})=>{var c,p;const[r,s]=d.exports.useState(localStorage.getItem("address")||""),o=d.exports.useContext(F),i=(c=o==null?void 0:o.addressesRef)!=null?c:null,l=g=>{s(g.target.value),localStorage.setItem("address",g.target.value)};return e=typeof e=="string"?e:e(r),u(we,{children:[t(be,{children:"\u4E0A\u4F20\u6210\u529F"}),i.current?u("div",{children:[u(z,{children:["\u8BF7 Windows \u7528\u6237\u5728\u9632\u706B\u5899\u5165\u7AD9\u89C4\u5219\u4E2D\u5F00\u901A 27149 \u7AEF\u53E3\uFF08",t("a",{href:"https://jingyan.baidu.com/article/09ea3ede7311dec0afde3977.html",target:"_blank",rel:"noreferrer",children:"\u6559\u7A0B"}),"\uFF09"]}),t(z,{children:u(ve,{children:[t(ye,{children:"\u8BF7\u9009\u62E9\u624B\u673A\u53EF\u4EE5\u8BBF\u95EE\u7684\u5C40\u57DF\u7F51IP"}),u("select",{value:r,onChange:l,children:[t("option",{value:"",disabled:!0,children:"- \u8BF7\u9009\u62E9 -"}),(p=i.current)==null?void 0:p.map(g=>t("option",{children:g},g))]})]})})]}):null,t(h,{children:e?t(me,{content:e}):null}),t(h,{children:e?t("a",{href:e,children:"\u8BF7 \u624B\u673A\u626B\u7801 \u6216 \u70B9\u51FB\u4E0B\u8F7D"}):null}),t(C,{}),t(h,{children:t(y,{onClick:n,children:"\u5173\u95ED"})})]})},Q=({context:e,content:n})=>{const r=L(t(J,{content:n,onClose:()=>r()}),{context:e})},E=({context:e,content:n})=>{const r=L(t(J,{content:n,onClose:()=>r()}),{context:e})},S=()=>L(t(P,{children:"\u4E0A\u4F20\u4E2D"})),we=a.div`
  padding: 16px;
`,_=(e,n)=>(T().then(r=>{r.send({clientId:x,type:n,url:e.data.url})}),e),Ce=e=>w.post("/api/v1/texts",{raw:e}).then(n=>_(n,"text")),R=e=>{const n=new FormData;return n.append("raw",e),w({method:"post",url:"/api/v1/files",data:n,headers:{"Content-Type":"multipart/form-data"}}).then(r=>_(r,"file"))},Y=()=>{const e=d.exports.useContext(F),[n,r]=d.exports.useState("");return u(H,{className:"uploadForm",onSubmit:async o=>{o.preventDefault(),S();const{data:{url:i}}=await Ce(n);Q({context:e,content:l=>l&&`http://${l}:27149/static/downloads?type=text&url=http://${l+":27149"+encodeURIComponent(i)}`})},children:[t("div",{className:"row",children:t(q,{value:n,onChange:o=>r(o.target.value)})}),t(h,{className:"row",children:t(y,{type:"submit",children:"\u4E0A\u4F20"})})]})},Ee=()=>{const e=d.exports.useContext(F),[n,r]=d.exports.useState("default");return t(H,{className:"uploadForm",children:t("div",{className:"row",children:u(Se,{onDrop:async c=>{var v,b,f;c.preventDefault();const p=(f=(b=(v=c.dataTransfer)==null?void 0:v.items)==null?void 0:b[0])==null?void 0:f.getAsFile();if(!p)return;const g=p.type||"unknown";S();const{data:{url:$}}=await R(p);E({context:e,content:D=>D&&`http://${D}:27149/static/downloads?type=${g}&url=${encodeURIComponent(`http://${D}:27149${$}`)}`})},onDragOver:c=>{c.preventDefault(),r("dragging")},onDragLeave:c=>{r("default")},className:n,children:[t($e,{type:"file",value:"",onChange:async c=>{var v,b;const p=(b=(v=c.target)==null?void 0:v.files)==null?void 0:b[0];if(!p)return;const g=p.type||"unknown";S();const{data:{url:$}}=await R(p);E({context:e,content:f=>f&&`http://${f}:27149/static/downloads?type=${g}&url=${encodeURIComponent(`http://${f}:27149${$}`)}`})}}),t("p",{children:"\u70B9\u51FB\u6253\u5F00\u6587\u4EF6 \u6216 \u62D6\u62FD\u6587\u4EF6\u81F3\u6B64"})]})})})},Se=a.div`
  &.dragging {
...
`,Be=t(De,{children:u("ul",{children:[t("li",{children:t(A,{to:"/message",activeClassName:"selected",children:"\u4F20\u6D88\u606F"})}),t("li",{children:t(A,{to:"/file",activeClassName:"selected",children:"\u4F20\u6587\u4EF6"})}),t("li",{children:t(A,{to:"/screenshot",activeClassName:"selected",children:"\u4F20\u622A\u56FE"})})]})}),Ne=()=>{const e=d.exports.useContext(F),n=async o=>{if(!o)return;const i=o.type||"unknown";S();const{data:{url:l}}=await R(o);E({context:e,content:c=>c&&`http://${c}:27149/static/downloads?type=${i}&url=${encodeURIComponent(`http://${c}:27149${l}`)}`})},r=o=>{const{items:[i]}=o.clipboardData;n(i==null?void 0:i.getAsFile())};return d.exports.useEffect(()=>(window.addEventListener("paste",r),()=>{window.removeEventListener("paste",r)}),[]),t(H,{className:"uploadForm",children:t("div",{className:"row",children:u(Ae,{children:[t(ke,{type:"file",value:"",onChange:async o=>{var i,l;n((l=(i=o.target)==null?void 0:i.files)==null?void 0:l[0])},accept:"image/*;capture=camera"}),t("p",{children:"\u70B9\u51FB\u9009\u62E9\u56FE\u7247 \u6216 \u76F4\u63A5\u7C98\u8D34\u56FE\u7247"})]})})})},Ae=a.div`
  &.dragging {
    border-color: ${({theme:e})=>e.highlightColor};
    color: ${({theme:e})=>e.highlightColor};
  }
...
`,ke=a.input`
  position: absolute; right: 0; top: 0; width: 100%; height: 100%;
  opacity: 0; cursor: pointer;
`;function Ie(){return u(M,{children:[t(W,{children:"\u540C\u6B65\u4F20"}),Be,u(O,{children:[t(m,{exact:!0,path:"/",children:t(Y,{})}),t(m,{exact:!0,path:"/message",children:t(Y,{})}),t(m,{exact:!0,path:"/file",children:t(Ee,{})}),t(m,{exact:!0,path:"/screenshot",children:t(Ne,{})})]})]})}const Le=()=>{const e=V();return X.parse(e.search)},G=ee({basename:"/static/"}),He=()=>{const e=Le(),n=Ue(e.type),[r,s]=d.exports.useState("");d.exports.useEffect(()=>{n==="text"&&w.get(e.url).then(({data:l})=>{s(l)})},[n]);let o=null;switch(n){case"text":o=u("div",{children:[t(q,{readOnly:!0,value:r}),t(C,{}),t(h,{virtical:!0,children:t(y,{children:"\u8BF7\u624B\u52A8\u590D\u5236\u4E0A\u9762\u6587\u672C"})})]});break;case"file":o=t(h,{virtical:!0,children:u("a",{href:e.url,children:[t("svg",{children:t("use",{xlinkHref:"#icon-file"})}),t(C,{}),t(h,{children:t(y,{children:"\u70B9\u51FB\u4E0B\u8F7D\u6587\u4EF6"})})]})});break;case"image":o=t(h,{children:u("a",{href:e.url,children:[t(Re,{src:e.url}),t(h,{children:t(y,{children:"\u957F\u6309\u6216\u70B9\u51FB\uFF0C\u5373\u53EF\u4E0B\u8F7D\u56FE\u7247"})})]})});break}return u(M,{children:[t(W,{children:"\u540C\u6B65\u4F20"}),o,t(C,{x3:!0}),t(h,{children:t(y,{onClick:()=>{G.push("/")},children:"\u6211\u4E5F\u8981\u4E0A\u4F20"})})]})},Re=a.img`
  border: 2px solid ${({theme:e})=>e.borderColor};
  margin: 16px;
`;a.p`
  margin: 8px 0;
`;const Ue=e=>/^image\/.*$/.test(e)?"image":/^text(\/.*)?$/.test(e)?"text":"file",Oe=te`
  0% {
...
`,je={borderColor:"#333",highlightColor:"#f5b70d"},Te=()=>{const e=d.exports.useRef(null),n={addressesRef:e};return d.exports.useEffect(async()=>{const{data:{addresses:r}}=await w.get("/api/v1/addresses").catch(s=>Promise.reject(s));e.current=re.uniq(r.concat("127.0.0.1"))},[]),d.exports.useEffect(()=>{T().then(r=>{r.onMessage(s=>{const{url:o,type:i}=s;if(s.clientId!==x){const l=c=>c&&`http://${c}:27149/static/downloads?type=${i}&url=${encodeURIComponent(`http://${c}:27149${o}`)}`;i==="text"?Q({context:n,content:l}):E({context:n,content:l})}})})},[]),u(ie,{theme:je,children:[t(Pe,{}),t(F.Provider,{value:n,children:t(se,{history:G,children:u(O,{children:[t(m,{exact:!0,path:"/downloads",children:t(He,{})}),t(m,{path:"/",children:t(Ie,{})}),t(m,{path:"*",children:t("div",{children:"404"})})]})})})]})};oe.render(t(U.StrictMode,{children:t(Te,{})}),document.getElementById("root"));
